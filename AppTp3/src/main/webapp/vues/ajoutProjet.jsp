<%-- ajoutProjet.jsp (Fig 5 : /ajoutProjet) --%>
    ...
    <div class="row" style="margin-top:10px;">
        <div class="col-3">
            <div class="list-group">
                ...
                <a href="${cxt}/ajoutProjet" class="list-group-item list-group-item-action active">
                    <span class="fa fa-th-large"></span>
                    Ajouter un projet
                </a>
            </div>
        ...
        <div class="col-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form:form method="POST" action="${cxt}/saveProjet" modelAttribute="projet">
                        <div class="mb-3">
                            <label>Titre</label>
                            <form:input path="titre" class="form-control" required="true"/>
                        </div>
                        <div class="mb-3">
                            <label>Etat</label>
                            <form:select path="etat" class="form-control">
                                <form:option value="non lancé">Non lancé</form:option>
                                <form:option value="active">Active</form:option>
                                <form:option value="achevé">Achevé</form:option>
                            </form:select>
                        </div>
                        <div class="mb-3">
