            ...
            <div class="card text-white">
                ...
                <table class="table table-hover">
                    <thead class="thead-light">
                        <tr><th>ID</th><th>Nom</th><th>Fonction</th><th>Action</th></tr>  <!-- Comme Fig.2 : Ajout Fonction -->
                    </thead>
                    <tbody>
                        <c:forEach items="${liste}" var="d">
                            <tr>
                                <td>${d.id}</td>
                                <td>${d.nom}</td>
                                <td>${d.fonction}</td>  <!-- Affichage fonction (TP2 requis, Fig.2) -->
                                <td></td>  <!-- Action vide comme Fig.2 -->
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
