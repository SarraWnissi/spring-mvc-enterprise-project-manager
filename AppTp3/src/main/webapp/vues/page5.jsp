    ...
    <div class="row" style="margin-top:10px;">
        ...
        <div class="col-9">
            <div class="card text-white">
                <div class="alert alert-primary"><h4>Projet: ${proj.titre}</h4></div>
                <div class="card-header bg-success">
                    <h5>Liste des employés</h5>
                </div>
                <table class="table table-hover">
                    <thead class="thead-light">
                        <tr><th>ID</th><th>Nom</th><th>Fonction</th><th>Action</th></tr>  <!-- Ajout Fonction comme Fig.4 -->
                    </thead>
                    <tbody>
                        <c:forEach items="${liste}" var="d">
                            <tr>
                                <td>${d.id}</td>
                                <td>${d.nom}</td>
                                <td>${d.fonction}</td>  <!-- Affichage fonction (TP2 requis) -->
                                <td></td>  <!-- Action vide comme Fig.4 -->
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
